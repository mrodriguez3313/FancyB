...
import { Region } from "../region.js"; //imports a function that randomly selects continent.

async function mintNFT({contract, ownerAddress, provider, gasPrice, setStatus, image, name, description, hive }) {
...
export default function Minter({
  ...
  const startMinting = () => {
    // Calls the function to pick a random continent at the point of minting.
    const Hive = Region();
    console.log(Hive);
